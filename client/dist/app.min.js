...
app.controller("EditQuestionController", [ "$scope", "$routeParams", "$location", "questionService", function($scope, $routeParams, $location, questionService) {
    $scope.loading = !1, $scope.saving = !1, $scope.data = {}, $scope.data.type = "choice", 
    angular.isDefined($routeParams.id) && ($scope.loading = !0, questionService.getQuestion($routeParams.id).success(function(data) {
        ...
        $scope.saving = !0;
        var promise;
        promise = angular.isUndefined($scope.data.id) ? questionService.addQuestion($scope.data) : questionService.saveQuestion($scope.data), 
...
app.controller("EditTestController", [ "$scope", "$routeParams", "testService", function($scope, $routeParams, testService) {
    $scope.loading = !1, $scope.saving = !1, $scope.data = {}, $scope.data.content = [], 
    angular.isDefined($routeParams.id) && ($scope.loading = !0, testService.getTest($routeParams.id).success(function(data) {
        $scope.data = data, $scope.loading = !1;
    }).error(function() {
        $scope.loading = !1;
        ...
        $scope.saving = !0;
        var promise;
        promise = angular.isUndefined($scope.data.id) ? testService.addTest($scope.data) : testService.saveTest($scope.data), 
        promise.success(function(data) {
            $scope.saving = !1, $scope.data.id = data.id;
        }).error(function() {
            $scope.saving = !1;
...
app.factory("userService", [ "$http", function($http) {
    ...
    $templateCache.put("views/logout.html", "<h1>Logout</h1>{user}"), $templateCache.put("views/question_edit.html", '<h1>Edit question</h1><button ng-click=saveQuestion() ng-disabled="saving || deleting">Save</button> <button ng-click=deleteQuestion() ng-disabled="deleting || saving">Delete</button> Blaat: {{data}}<div ng-show=loading>Loading</div><div ng-hide=loading><question-editor data=data></question-editor></div>'), 
    ...
    $templateCache.put("views/test_edit.html", "<h1>Edit Test</h1><button ng-click=saveTest() ng-disabled=saving>Save</button> Blaat: {{data}}<div ng-show=loading>Loading</div><div ng-hide=loading><test-editor data=data></test-editor></div>"), 
