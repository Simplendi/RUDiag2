...
var app = angular.module("app", [ "ngRoute", "ngSanitize", "ui.bootstrap" ]), auth_is_user = function(user) {
    return user;
}, auth_is_admin = function(user) {
...
app.config([ "$routeProvider", function($routeProvider) {
    ...
    $rootScope.$on("$routeChangeStart", function(ev, next) {
        if (next.$$route) {
            var user = $rootScope.user, auth = next.$$route.auth;
            angular.isUndefined(user) ? ($rootScope.loadingLoginStatus = !0, loginService.getLoginStatus().success(function(data) {
                $rootScope.user = user = data, $rootScope.loadingLoginStatus = !1, user || $location.path("/login");
            }).error(function() {
                $location.path("/login");
            })) : auth && !auth(user) && $location.path("/login");
        }
    });
} ]);
...
app.controller("EditMetadataController", [ "$scope", "$modal", "$location", "$routeParams", "metadataService", function($scope, $modal, $location, $routeParams, metadataService) {
    $scope.loading = !1, $scope.saving = !1, $scope.deleting = !1, $scope.data = {}, 
    angular.isDefined($routeParams.id) && ($scope.loading = !0, metadataService.getMetadata($routeParams.id).success(function(data) {
        $scope.data = data, $scope.loading = !1;
    }).error(function() {
        $scope.loading = !1, $location.path("/metadata/");
    })), $scope.saveMetadata = function() {
        $scope.saving = !0;
        var promise;
        angular.isUndefined($routeParams.id) ? (promise = metadataService.addMetadata($scope.data), 
        promise = promise.success(function(data) {
            $location.path("/metadata/" + data.id + "/edit").replace();
        })) : promise = metadataService.saveMetadata($scope.data), promise.success(function(data) {
            $scope.saving = !1, $scope.data.id = data.id;
        }).error(function() {
            $scope.saving = !1;
        });
        ...
        deleteMetadataModal.result.then(function() {
            metadataService.deleteMetadata($scope.data.id).success(function() {
...
app.controller("EditQuestionController", [ "$scope", "$routeParams", "$location", "questionService", function($scope, $routeParams, $location, questionService) {
    $scope.loading = !1, $scope.saving = !1, $scope.deleting = !1, $scope.data = {}, 
    $scope.data.type = "choice", angular.isDefined($routeParams.id) && ($scope.loading = !0, 
    questionService.getQuestion($routeParams.id).success(function(data) {
        $scope.data = data, $scope.loading = !1;
    }).error(function() {
        $scope.loading = !1;
        ...
        $scope.saving = !0;
        var promise;
        angular.isUndefined($scope.data.id) ? (promise = questionService.addQuestion($scope.data), 
        promise = promise.success(function(data) {
            $location.path("/question/" + data.id + "/edit").replace();
        })) : promise = questionService.saveQuestion($scope.data), promise.success(function(data) {
            $scope.saving = !1, $scope.data.id = data.id;
        }).error(function() {
            $scope.saving = !1;
        });
    }, $scope.deleteQuestion = function() {
        $scope.deleting = !0, questionService.deleteQuestion($scope.data).success(function() {
...
app.controller("EditTestController", [ "$scope", "$modal", "$location", "$routeParams", "testService", function($scope, $modal, $location, $routeParams, testService) {
    $scope.loading = !1, $scope.saving = !1, $scope.deleting = !1, $scope.data = {}, 
    $scope.data.content = [], angular.isDefined($routeParams.id) && ($scope.loading = !0, 
    testService.getTest($routeParams.id).success(function(data) {
        $scope.data = data, $scope.loading = !1;
    }).error(function() {
        $scope.loading = !1, $location.path("/test/");
    })), $scope.saveTest = function() {
        $scope.saving = !0;
        var promise;
        angular.isUndefined($scope.data.id) ? (promise = testService.addTest($scope.data), 
        promise = promise.success(function(data) {
            $location.path("/test/" + data.id + "/edit").replace();
        })) : promise = testService.saveTest($scope.data), promise.success(function(data) {
            $scope.saving = !1, $scope.data.id = data.id;
        }).error(function() {
            $scope.saving = !1;
        });
        ...
        deleteTestModal.result.then(function() {
            testService.deleteTest($scope.data.id).success(function() {
                $location.path("/test/");
            });
        }, function() {
            $scope.deleting = !1;
...
app.controller("ListMetadataController", [ "$scope", "$modal", "metadataService", function($scope, $modal, metadataService) {
    $scope.loading = !0, $scope.filter = {}, $scope.metadatas = [], $scope.loadMetadata = function() {
        metadataService.listMetadata($scope.filter).success(function(metadata) {
...
app.controller("ListQuestionController", [ "$scope", "questionService", function($scope, questionService) {
    $scope.loading = !0, $scope.filter = {}, $scope.questions = [], $scope.loadQuestions = function() {
        questionService.listQuestion($scope.filter).success(function(questions) {
...
app.controller("ListTestController", [ "$scope", "$modal", "testService", function($scope, $modal, testService) {
    $scope.loading = !0, $scope.filter = {}, $scope.tests = [], $scope.loadTests = function() {
        testService.listTest($scope.filter).success(function(tests) {
            $scope.tests = tests;
        });
    }, $scope.loadTests();
} ]);
...
app.controller("ListUserController", [ "$scope", "userService", function($scope, userService) {
    $scope.loading = !0, $scope.filter = {}, $scope.users = [], $scope.loadUsers = function() {
        userService.listUser($scope.filter).success(function(users) {
            $scope.users = users;
        });
    }, $scope.loadUsers();
} ]);
...
app.controller("LoginController", [ "$scope", "$rootScope", "$location", "loginService", function($scope, $rootScope, $location, loginService) {
    $scope.onLoginClick = function() {
        loginService.doLogin($scope.username, $scope.password).success(function(data) {
            $location.url("/"), $rootScope.user = data;
        }).error(function() {
...
app.directive("choiceQuestionEditor", function() {
    return {
        ...
        controller: [ "$scope", function($scope) {
            angular.isUndefined($scope.data.options) && ($scope.data.options = []), $scope.addOption = function() {
...
app.directive("testEditor", function() {
    return {
        ...
        controller: [ "$scope", "$modal", function($scope, $modal) {
            $scope.addTextElement = function() {
                ...
                var oldIndex = $index, newIndex = $index - 1, element = $scope.data.content[$index];
                $scope.data.content.splice(oldIndex, 1), $scope.data.content.splice(newIndex, 0, element);
            }, $scope.moveElementDown = function($index) {
                var oldIndex = $index, newIndex = $index + 1, element = $scope.data.content[$index];
                $scope.data.content.splice(oldIndex, 1), $scope.data.content.splice(newIndex, 0, element);
            }, $scope.openTest = function() {}, $scope.openTestNow = function() {}, $scope.closeTestNow = function() {};
        } ]
    };
    ...
    $scope.loading = !0, $scope.questions = [], $scope.loadQuestions = function() {
        questionService.listQuestion({}).success(function(questions) {
            $scope.questions = questions;
        });
...
app.factory("userService", [ "$http", function($http) {
    ...
    "use strict";
    $templateCache.put("views/home.html", "<h1>Home</h1>"), $templateCache.put("views/login.html", '<h1>Login</h1><label for=input_username>Username:</label><input id=input_username ng-model="username"><label for=input_password>Password:</label><input id=input_password type=password ng-model="password"> <button ng-click=onLoginClick()>Login</button>'), 
    $templateCache.put("views/logout.html", "<h1>Logout</h1>{user}"), $templateCache.put("views/metadata_edit.html", '<h1>Edit Metadata</h1><button ng-click=saveMetadata() ng-disabled="saving || deleting">Save</button> <button ng-click=deleteMetadata() ng-disabled="deleting || saving">Delete</button><div ng-show=loading>Loading</div><div ng-hide=loading><metadata-editor data=data></metadata-editor></div>'), 
    $templateCache.put("views/metadata_list.html", '<h1>Metadata</h1><label>Search</label><input ng-model="search"><div ng-repeat="metadata in metadatas | filter:{id: search}"><span>{{metadata.id}}</span><a href=#/metadata/{{metadata.id}}/edit class=btn>Edit</a></div><a href=#/metadata/add class=btn>Add</a>'), 
    $templateCache.put("views/question_edit.html", '<h1>Edit question</h1><button ng-click=saveQuestion() ng-disabled="saving || deleting">Save</button> <button ng-click=deleteQuestion() ng-disabled="deleting || saving">Delete</button><div ng-show=loading>Loading</div><div ng-hide=loading><question-editor data=data></question-editor></div>'), 
    $templateCache.put("views/question_list.html", '<h1>Questions</h1><label>Search</label><input ng-model="search"><div ng-repeat="question in questions | filter:{question: search}"><span>{{question.question}}</span><a href=#/question/{{question.id}}/edit class=btn>Edit</a></div><a href=#/question/add class=btn>Add</a>'), 
    $templateCache.put("views/test_edit.html", '<h1>Edit Test</h1><button ng-click=saveTest() ng-disabled="loading || saving || deleting">Save</button> <button ng-click=deleteTest() ng-hide=!data.id ng-disabled="loading || deleting || saving">Delete</button><div ng-show=loading>Loading</div><div ng-hide=loading><test-editor data=data></test-editor></div>'), 
    $templateCache.put("views/test_edit_delete_test.html", "<div class=modal-header><h3>Delete test</h3></div><div class=modal-body>Do you want to delete the test? If the test is deleted, all data and answers are lost!</div><div class=modal-footer><button ng-click=ok()>Delete</button> <button ng-click=cancel()>Cancel</button></div>"), 
    $templateCache.put("views/test_list.html", '<h1>Tests</h1><label>Search</label><input ng-model="search"><div ng-repeat="test in tests | filter:{title: search}"><span>{{test.title}}</span><a href=#/test/{{test.id}}/edit class=btn>Edit</a></div><a href=#/test/add class=btn>Add</a>'), 
    $templateCache.put("views/user_list.html", '<h1>Users</h1><label>Search</label><input ng-model="search"><div ng-repeat="user in users | filter:{$: search}"><span>{{user.fullname}}</span><a href=#/user/{{user.id}}/edit class=btn>Edit</a></div><a href=#/user/add class=btn>Add</a>'), 
    $templateCache.put("views/directives/choice_question_editor.html", '<label>Question</label><br><textarea ng-model=data.question ng-disabled=disabled></textarea><br><span ng-repeat="option in data.options track by $index"><input type=radio disabled><input ng-model=data.options[$index] ng-disabled="disabled"><br></span> <button ng-click=addOption() ng-show=!disabled>Add option</button><br><textarea ng-model=data.question_after ng-disabled=disabled></textarea><br>'), 
    $templateCache.put("views/directives/metadata_editor.html", '<label>Id</label><input ng-model=data.id><br><label>Type</label><input ng-model=data.type><br><label>Data</label><textarea ng-model=data.data></textarea><br><label>Multivalue</label><input ng-model=data.multivalue type="checkbox"><br>'), 
    $templateCache.put("views/directives/multiplechoice_question_editor.html", '<label>Question</label><br><textarea ng-model=data.question></textarea><br><span ng-repeat="option in data.options track by $index"><input type=checkbox disabled><input ng-model="data.options[$index]"><br></span> <button ng-click=addOption()>Add option</button><br><textarea ng-model=data.question_after></textarea><br>'), 
    $templateCache.put("views/directives/open_question_editor.html", "<label>Question</label><br><textarea ng-model=data.question></textarea><br><input disabled><br><textarea ng-model=data.question_after></textarea><br>"), 
    $templateCache.put("views/directives/question_editor.html", "<tabset><tab heading=Content><label>Type</label><br><select ng-model=data.type ng-disabled=disabled><option value=choice>Choice</option><option value=multiplechoice>Multiple choice</option><option value=open>Open</option></select><br><choice-question-editor ng-if=\"data.type=='choice'\" ng-disabled=disabled data=data></choice-question-editor><multiplechoice-question-editor ng-if=\"data.type=='multiplechoice'\" ng-disabled=disabled data=data></multiplechoice-question-editor><open-question-editor ng-if=\"data.type=='open'\" ng-disabled=disabled data=data></open-question-editor></tab><tab ng-if=!inline heading=Answers></tab><tab ng-if=!inline heading=Feedback><label>Wrong</label><br><textarea ng-model=data.feedback.wrong></textarea><br><label>Right</label><br><textarea ng-model=data.feedback.right></textarea></tab><tab heading=Metadata>TODO</tab><tab ng-if=!inline heading=Permissions>TODO</tab></tabset>"), 
    $templateCache.put("views/directives/test_editor.html", '<tabset><tab heading=Content><label>Title</label><input ng-model="data.title"><div ng-repeat="element in data.content track by $index"><button ng-click=deleteElement($index)>Delete</button> <button ng-if=!$first ng-click=moveElementUp($index)>Up</button> <button ng-if=!$last ng-click=moveElementDown($index)>Down</button> <button ng-if="data.content[$index].data.id!=undefined" ng-click=makeQuestionLocal($index)>Edit</button><br><question-editor ng-if="data.content[$index].type==\'question\'" ng-disabled="data.content[$index].data.id!=undefined" inline=true data=data.content[$index].data></question-editor><test-text-editor ng-if="data.content[$index].type==\'text\'" data=data.content[$index].data></test-text-editor></div><div><button ng-click=addTextElement()>Add text element</button> <button ng-click=addNewQuestionElement()>Add new question</button> <button ng-click=addExistingQuestionElement()>Add exisisting question</button></div></tab><tab heading=Feedback>TODO</tab><tab heading=Planning><label>Status</label>{{data.planning.status}} <button ng-click=openTest()>Plan test</button><button ng-click=openTestNow()>Open Test</button><br><label>Invite mode</label><select ng-model=data.planning.invite_mode><option value=url_request>URL to request invite by e-mail</option><option value=url_login>URL to login</option><option value=code>Code</option><option value=email>Email</option></select><br><label>Start</label><datepicker ng-model=data.planning.start_date></datepicker><timepicker ng-model=data.planning.start_date show-meridian=false></timepicker><label>End</label><datepicker min-date=data.planning.start_date ng-model=data.planning.end_date></datepicker><timepicker min-date=data.planning.start_date ng-model=data.planning.end_date show-meridian=false></timepicker></tab><tab heading=Permissions>TODO</tab></tabset>'), 
    $templateCache.put("views/directives/test_editor_delete_question.html", "<div class=modal-header><h3>Delete question</h3></div><div class=modal-body>Do you want to delete the question from the test? If this question is local all data entered will be lost.</div><div class=modal-footer><button ng-click=ok()>Delete</button> <button ng-click=cancel()>Cancel</button></div>"), 
    $templateCache.put("views/directives/test_editor_make_question_local.html", "<div class=modal-header><h3>Make question local</h3></div><div class=modal-body>Do you want to make the question local to the test? By doing this the question in the test will not be updated when the question in the database is changed.</div><div class=modal-footer><button ng-click=ok()>Ok</button> <button ng-click=cancel()>Cancel</button></div>"), 
    $templateCache.put("views/directives/test_editor_select_question.html", '<div class=modal-header><h3>Select existing question</h3></div><div class=modal-body><input ng-model="search"><div ng-repeat="question in questions | filter:{question: search}"><span>{{question.question}}</span><a href=javascript:void(0) ng-click=selectQuestion(question) class=btn>Select</a></div></div><div class=modal-footer><button ng-click=cancel()>Cancel</button></div>'), 
    $templateCache.put("views/directives/test_text_editor.html", "<label>Text</label><br><textarea ng-model=data></textarea>");
} ]);
